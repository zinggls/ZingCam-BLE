...
public:
	...
	static long ppI2C_SendData(long deviceAddr, std::vector<BYTE> dataIN, std::wstring& strError);
	static long ppI2C_ReadData(long deviceAddr, long readLen, std::vector<BYTE>& dataOUT, std::wstring& strError);
};
...
BOOL CZiieDlg::OnInitDialog()
{
	...
	m_zcdListCtrl.InsertColumn(0, _T("Kind"), LVCFMT_LEFT, 65);
	m_zcdListCtrl.InsertColumn(1, _T("USB"), LVCFMT_LEFT, 65);
	m_zcdListCtrl.InsertColumn(2, _T("PPID"), LVCFMT_LEFT, 65);
	m_zcdListCtrl.InsertColumn(3, _T("DeviceID"), LVCFMT_LEFT, 65);
	m_zcdListCtrl.InsertColumn(4, _T("FMT"), LVCFMT_LEFT, 65);
	m_zcdListCtrl.InsertColumn(5, _T("IDX"), LVCFMT_LEFT, 65);
	m_zcdListCtrl.InsertColumn(6, _T("FPS"), LVCFMT_LEFT, 65);
	m_zcdListCtrl.InsertColumn(7, _T("TRT"), LVCFMT_LEFT, 65);
	m_zcdListCtrl.InsertColumn(8, _T("ACK"), LVCFMT_LEFT, 65);
	m_zcdListCtrl.InsertColumn(9, _T("PPC"), LVCFMT_LEFT, 65);
	m_zcdListCtrl.InsertColumn(10, _T("RUN"), LVCFMT_LEFT, 65);
	m_zcdListCtrl.InsertColumn(11, _T("ITF"), LVCFMT_LEFT, 65);
	m_zcdListCtrl.InsertColumn(12, _T("TXID"), LVCFMT_LEFT, 65);
	m_zcdListCtrl.InsertColumn(13, _T("RXID"), LVCFMT_LEFT, 65);
	m_zcdListCtrl.InsertColumn(14, _T("DestID_ERR_CNT"), LVCFMT_LEFT, 120);
	m_zcdListCtrl.InsertColumn(15, _T("PHY_RX_FRAME_CNT"), LVCFMT_LEFT, 120);
	m_zcdListCtrl.InsertColumn(16, _T("MFIR"), LVCFMT_LEFT, 65);
	m_zcdListCtrl.InsertColumn(17, _T("CNT"), LVCFMT_LEFT, 65);
...
HRESULT CZiieDlg::Read_I2C_SCB_Slave(int deviceAddress, DWORD dwMilliseconds)
{
	...
	while (1) {
		...
		m_zcdListCtrl.SetItemText(nItem, 0, ToIntStr(dataOUT, 99));
		m_zcdListCtrl.SetItemText(nItem, 1, ToIntStr(dataOUT, 103));

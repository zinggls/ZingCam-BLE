...
attribute port_location of LED_BLUE(0) : label is "PORT(5,7)"; -- BUTTON 2 GREEN LED
attribute port_location of LED_GREEN(0) : label is "PORT(5,5)"; -- BUTTON 1 GREEN LED
attribute port_location of LED_RED(0) : label is "PORT(5,2)"; -- BUTTON 0 GREEN LED
